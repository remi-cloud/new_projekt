...
- **Meme Universe · Launch Scout** (`/launch`, **flagship**): Seed (~$200 MC) + Pump top-30 traders + Robinhood chain + multi-DEX + whispers — token clicks open Axiom (chain-aware) / DexScreener / Pump fallbacks; see `docs/LAUNCH-SCOUT.md`.

## Multi-agent priorities (coordinator)

| Priority | Modules |
|----------|---------|
| **P0** | LinkGuard (terminal URLs), TickWatchdog (`scripts/audit.sh`) |
| **P1** | Launch Scout, Axiom, FOMO Ghost |
| **P2** | Singularity, Finance Agent, Execution Agent, Binance AI bridge |
